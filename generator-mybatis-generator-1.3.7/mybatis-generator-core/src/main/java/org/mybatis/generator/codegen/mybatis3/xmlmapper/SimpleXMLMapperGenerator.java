...
public class SimpleXMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addBaseSelectColumnElement(answer);
    ...
    protected void addBaseSelectColumnElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new BaseSelectColumnElementGenerator();
